...
public class PointController {
  ...
  public ResponseEntity<Object> getPoints(@PathVariable("deviceId") String deviceId,
  ...
  public ResponseEntity<Object> savePoint(@RequestBody PointModel point) {
    pointService.save(PointAdapter.toEntity(point));
    return new ResponseEntity<>(HttpStatus.CREATED);
  }

  @RequestMapping(method = RequestMethod.PUT, path = "points/{id}")
  public ResponseEntity<Object> updatePoint(@PathVariable String id,
  ...
  public ResponseEntity<Object> deletePoint(@PathVariable String id) {
